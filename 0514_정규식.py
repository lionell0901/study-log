...
Life is egg
kim  700123-1239119 kim1234@naver.com
"""
...
for line in data.split("\n"):
    ...
    for word in line.split(" "):
        ...
        # '-' 앞의 6자리가 숫자여야 한다. word[:6] - 0~5번까지 슬라이싱
        # '-' 뒤의 7자리가 숫쟈여야 한다. word[7:] - 7번부터 마지막까지 전체 숫자로만 구성되어 있느냐
...
pat = re.compile("(\d{6})[-]\d{7}")  # \d숫자 {6} 여섯자리 [-] \d{7} 일곱자리
