...
def myadd(*args): #변수 하나에 값을 여러개 전달한다
    print(type(args)) # *arg - tuple로 전달하겠다
    for a in args:
        print(a)
...
#일반인자와 tuple 인자를 같이 써야 할때는 일반 인자가 먼저 와야 한다
#나머지를 tuple로 받으니까
